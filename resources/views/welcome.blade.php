    ...
    <body class="back">
        <div>
            ...
            <div class="part2">
                ...
                <h2 id="Ingredient" class="titre-acc">Une équipe de passionnée.</h2>
                <div  class="container-photo">
                    <img class="photo-acc" src="/image/photo-groupe.webp">
                    <p>L'équipe de cuisiniers du restaurant est passionnée et expérimentée dans la cuisine traditionnelle bretonne. Le chef dirige l'équipe, accompagné de chefs de partie et de commis de cuisine qui travaillent ensemble avec rigueur et créativité pour offrir des plats authentiques et savoureux.</p>
